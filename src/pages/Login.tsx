        ...
        <div className="h-[100dvh] w-full flex bg-[#0A0A0B] relative overflow-hidden">
                ...
                <div className="w-full max-w-md mx-auto relative z-10">
                    <div className="glass-panel p-10 rounded-3xl border border-brand-border/40 shadow-[0_0_40px_rgba(0,0,0,0.5)] bg-[#0A0A0B]/60 backdrop-blur-xl">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                            ...
                            <Button type="submit" size="lg" className="w-full mt-4 uppercase tracking-widest text-sm font-bold shadow-[0_4px_15px_rgba(255,94,0,0.3)] border-none bg-brand-neon hover:bg-[#FF5E00]/90 text-[#0A0A0B]" isLoading={isSubmitting} rightIcon={<LogIn className="w-5 h-5" />}>Entrar no Dashboard</Button>
            ...
            <div className="flex lg:hidden flex-col w-full h-full relative z-20 bg-[#0A0A0B]">
                ...
                <div className="flex-1 overflow-y-auto px-5 pt-8 pb-[120px] custom-scrollbar">
                    ...
                    <form id="mobile-login-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <Input 
                ...
                {/* 3. Bottom Action Bar Fixa (Botão de Login) */}
                <div className="fixed bottom-0 left-0 right-0 p-4 bg-[#0A0A0B]/95 backdrop-blur-2xl border-t border-brand-border/20 shadow-[0_-10px_30px_rgba(0,0,0,0.5)] z-50 pb-safe">
                    <Button
                        type="submit"
                        form="mobile-login-form" // Liga o botão da barra inferior ao formulário
                        size="lg"
